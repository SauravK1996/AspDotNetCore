...
namespace EmployeeManagement.Controllers
{
    ...
    public class AdministrationController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> MangeUserClaims(UserClaimsViewModel model)
        {
        ...
        public async Task<IActionResult> MangeUserRoles(string userId)
        {
        ...
        [HttpPost]
        //[Authorize(Policy = "EditRolePolicy")]
        public async Task<IActionResult> MangeUserRoles(List<UserRolesViewModel> model,string userId)
        {
            var user = await userManager.FindByIdAsync(userId);
